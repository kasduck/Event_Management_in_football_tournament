...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    ...
    <tr bgcolor="#0066CC">
      ...
      <td width="200">Home Score</td>
	     <td width="200">Away Score</td>
      <td width="200">Stadium Name</td>
	    <td width="200">Match Time</td>
   
    </tr>
	 <?php
include('DBConnect.php');
  $sql="select hometeam,awayteam,homescore,awayscore,stadiumname,matchtime from matches  ";
