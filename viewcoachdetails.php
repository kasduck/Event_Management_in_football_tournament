...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    ...
    <tr>
	  <td colspan="5"><div align="center">View Coach </div></td>
      </tr>
    <tr bgcolor="#0066CC">
...
include('DBConnect.php');
  $sql="select clicenceno,name,nationality,teamid,picc from coach  ";
  ...
  ?>
    <tr>
	   <td class="style11" ><?php echo $row[0]; ?></td>
		...
		<td class="style11"><?php echo "<img src='$row[4]'  height='100px' width='100px'/>";?></td>
