...
<li><a href="uregistration.php">Registration</a>
  ...
  <tr>
    <td><div align="center">
	<form name="frm" action="uinsert.php" method="post"  enctype="multipart/form-data">
      <table width="500" border="0" class="style9">
        <tr>
          <td colspan="2" bgcolor="#0099FF"><div align="center" class="style10">User Details </div></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="style11"><input name="txtpassword" type="password" id="txtpassword" /></td>
        </tr>
        <tr>
