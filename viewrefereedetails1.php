...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    ...
    <tr>
	  <td colspan="4"><div align="center">View Referee </div></td>
      </tr>
    <tr bgcolor="#0066CC">
...
include('DBConnect.php');
  $sql="select rlicenceno,city,name,picc from referee  ";
  ...
  ?>
    <tr>
	   <td class="style11" ><?php echo $row[0]; ?></td>
		...
		<td class="style11"><?php echo "<img src='$row[3]'  height='100px' width='100px'/>";?></td>
