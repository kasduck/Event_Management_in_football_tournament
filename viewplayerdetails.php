...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    ...
    <tr>
	  <td colspan="6"><div align="center">View Players </div></td>
      </tr>
    <tr bgcolor="#0066CC">
	  <td width="200">Licenceno</td>
      <td width="200">Natioality</td>
...
include('DBConnect.php');
  $sql="select plicenceno,nationality,placeofbirth,dateofbirth,name,picc from players  ";
  ...
  ?>
    <tr>
	   <td class="style11" ><?php echo $row[0]; ?></td>
		...
		<td class="style11"><?php echo "<img src='$row[5]'  height='100px' width='100px'/>";?></td>
