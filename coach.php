...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    <td>
	 <form name="frm" action="coachinsert.php" method="post"  enctype="multipart/form-data">
	 
      <table width="500" border="0" align="center" class="style9">
        <tr>
          <td colspan="2" bgcolor="#0099FF"><div align="center" class="style10">Coach Details </div></td>
        </tr>
        <tr>
          <td width="200" class="style11">C Licence Number </td>
          <td class="style11"><input name="clid" type="text" id="clid">          </td>
        </tr>
        <tr>
          <td class="style11">Coach Name </td>
