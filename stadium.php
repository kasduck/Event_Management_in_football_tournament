...
<li><a href="index.php">Logout</a></li>
  ...
  <tr>
    <td><div align="center">
	<form name="frm" action="stadiuminsert.php" method="post"  enctype="multipart/form-data">
      <table width="500" border="0" class="style9">
        <tr>
          <td colspan="2" bgcolor="#0099FF"><div align="center" class="style10">Stadium Details </div></td>
        </tr>
        <tr>
          <td width="200" class="style11">Stadium Id </td>
          <td class="style11"><input name="txtsid" type="text" id="txtsid">          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="style11">Capacity</td>
          <td class="style11"><input name="txtcapacity" type="text" id="txtcapacity" />          </td>
        </tr>
        <tr>
          <td class="style11">Surface Type </td>
          <td class="style11"><input name="txtsurface" type="text" id="txtsurface" /></td>
        </tr>
        <tr>
          <td class="style11">Team Id </td>
          <td class="style11"><input name="txtteamid" type="text" id="txtteamid" /></td>
        </tr>
        <tr>
